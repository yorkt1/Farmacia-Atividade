            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-md-12">
                        <img src="https://www.farmarcas.com.br/wp-content/uploads/2020/08/Ultra.png" alt="Far Márcia" className="img-fluid" />
                    </div>
                    <div className="col-lg-6 col-md-12">
                        <div className="abt-text">
                            <p className="top-sub">Desde de 2024</p>
                            <h2>Far <span className="orange-text">Márcia</span></h2>
                            <p><strong>Márcia Maria Mirenda</strong></p>
                            <p>Idade: 32 anos</p>
